...
8. Run the research validator and then the directions validator. Present `reference-board.md`, the evidence summary, and the mood directions together for review. In the response, present every direction as a complete block with:
